...
MDR_CAN_TypeDef                     mdr_can1_base;
MDR_CAN_TypeDef                     mdr_can2_base;
MDR_USB_TypeDef                     mdr_usb_base;
MDR_EEPROM_TypeDef                  mdr_eeprom_base;
MDR_RST_CLK_TypeDef                 mdr_rst_clk_base;
MDR_DMA_TypeDef                     mdr_dma_base;
MDR_UART_TypeDef                    mdr_uart1_base;
MDR_UART_TypeDef                    mdr_uart2_base;
MDR_SSP_TypeDef                     mdr_ssp1_base;
MDR_MIL_STD_1553_TypeDef            mdr_mil_std_15531_base;
MDR_MIL_STD_1553_TypeDef            mdr_mil_std_15532_base;
MDR_POWER_TypeDef                   mdr_power_base;
MDR_WWDG_TypeDef                    mdr_wwdg_base;
MDR_IWDG_TypeDef                    mdr_iwdg_base;
MDR_TIMER_TypeDef                   mdr_timer1_base;
MDR_TIMER_TypeDef                   mdr_timer2_base;
MDR_TIMER_TypeDef                   mdr_timer3_base;
MDR_ADC_TypeDef                     mdr_adc_base;
MDR_DAC_TypeDef                     mdr_dac_base;
MDR_TIMER_TypeDef                   mdr_timer4_base;
MDR_SSP_TypeDef                     mdr_ssp2_base;
MDR_PORT_TypeDef                    mdr_porta_base;
MDR_PORT_TypeDef                    mdr_portb_base;
MDR_PORT_TypeDef                    mdr_portc_base;
MDR_PORT_TypeDef                    mdr_portd_base;
MDR_PORT_TypeDef                    mdr_porte_base;
MDR_ARINC429R_TypeDef               mdr_arinc429r_base;
MDR_BKP_TypeDef                     mdr_bkp_base;
MDR_ARINC429R_TypeDef               mdr_arinc429t_base;
MDR_PORT_TypeDef                    mdr_portf_base;
MDR_EBC_TypeDef                     mdr_ebc_base;
MDR_SSP_TypeDef                     mdr_ssp3_base;
MDR_ETHERNET_TypeDef                mdr_ethernet1_base;

#define MDR_CAN1_BASE               (&mdr_can1_base)
#define MDR_CAN2_BASE               (&mdr_can2_base)
#define MDR_USB_BASE                (&mdr_usb_base)
#define MDR_EEPROM_BASE             (&mdr_eeprom_base)
#define MDR_RST_CLK_BASE            (&mdr_rst_clk_base)
#define MDR_DMA_BASE                (&mdr_dma_base)
#define MDR_UART1_BASE              (&mdr_uart1_base)
#define MDR_UART2_BASE              (&mdr_uart2_base)
#define MDR_SSP1_BASE               (&mdr_ssp1_base)
#define MDR_MIL_STD_15531_BASE      (&mdr_mil_std_15531_base)
#define MDR_MIL_STD_15532_BASE      (&mdr_mil_std_15532_base)
#define MDR_POWER_BASE              (&mdr_power_base)
#define MDR_WWDG_BASE               (&mdr_wwdg_base)
#define MDR_IWDG_BASE               (&mdr_iwdg_base)
#define MDR_TIMER1_BASE             (&mdr_timer1_base)
#define MDR_TIMER2_BASE             (&mdr_timer2_base)
#define MDR_TIMER3_BASE             (&mdr_timer3_base)
#define MDR_ADC_BASE                (&mdr_adc_base)
#define MDR_DAC_BASE                (&mdr_dac_base)
#define MDR_TIMER4_BASE             (&mdr_timer4_base)
#define MDR_SSP2_BASE               (&mdr_ssp2_base)
#define MDR_PORTA_BASE              (&mdr_porta_base)
#define MDR_PORTB_BASE              (&mdr_portb_base)
#define MDR_PORTC_BASE              (&mdr_portc_base)
#define MDR_PORTD_BASE              (&mdr_portd_base)
#define MDR_PORTE_BASE              (&mdr_porte_base)
#define MDR_ARINC429R_BASE          (&mdr_arinc429r_base)
#define MDR_BKP_BASE                (&mdr_bkp_base)
#define MDR_ARINC429T_BASE          (&mdr_arinc429t_base)
#define MDR_PORTF_BASE              (&mdr_portf_base)
#define MDR_EBC_BASE                (&mdr_ebc_base)
#define MDR_SSP3_BASE               (&mdr_ssp3_base)
#define MDR_ETHERNET1_BASE          (&mdr_ethernet1_base)
